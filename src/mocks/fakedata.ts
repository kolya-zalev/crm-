...
export const fakeTasks: Task[] = [
  ...
  },
  {
    ...
    description:
      "Review the technical specifications sent by the client's CTO.",
    status: "pending",
    priority: "high",
  ...
  },
  {
    ...
    description: "Export contact details to the marketing mailing list.",
    status: "completed",
    priority: "low",
    dueDate: new Date(Date.now() - 86400000 * 1).toISOString(),
    createdAt: new Date(Date.now() - 86400000 * 2).toISOString(),
  ...
  },
  {
    ...
    description: "Get feedback on the trial period.",
    status: "pending",
    priority: "medium",
