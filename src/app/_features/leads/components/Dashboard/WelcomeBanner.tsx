...
<Card className="w-full bg-linear-to-r from-blue-50 to-indigo-50 animate-in fade-in slide-in-from-bottom-4 duration-2000  fill-mode-forwards  shadow-sm hover:shadow-xl transition-shadow shadow-red-200">
        <CardHeader>
